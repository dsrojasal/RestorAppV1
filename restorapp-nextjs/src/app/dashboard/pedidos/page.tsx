  ...
  return (
    <>
      <div className="animate-in">
        ...
        <p className="page-subtitle">Gestión de pedidos de mesas y domicilios.</p>
      </div>
      <div className="card-data animate-in animate-in-delay-1" style={{ textAlign: 'center', padding: '60px 24px' }}>
        <span className="material-symbols-outlined" style={{ fontSize: 64, color: 'var(--primary)', marginBottom: 16 }}>receipt_long</span>
